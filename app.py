...
app = Flask(__name__)
app_env = AppEnv()
CORS(app, origins=['https://federalist-c8f0d18e-b710-44dc-9412-4b4f26efb0a3.sites.pages.cloud.gov', 'http://127.0.0.1:8081', 'http://127.0.0.1:8080'], headers=['Content-Type'], methods=['GET'])
